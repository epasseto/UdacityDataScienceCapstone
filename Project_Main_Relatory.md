...
(\*or perhaps some **metrics**, what we will discuss later)
...
accuracy=correctpredictionstotalofpredictions
...
F1score=2∗precison∗recallprecision+recall
